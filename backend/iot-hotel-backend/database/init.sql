...
CREATE TABLE devices (
    ...
    last_card_uid VARCHAR(50) DEFAULT NULL COMMENT '最后感应到的卡片UID',
...
CREATE TABLE rfid_cards (
    ...
    member_id INT DEFAULT NULL,
    holder_name VARCHAR(100) DEFAULT NULL COMMENT '特权持卡人姓名',
    holder_id VARCHAR(50) DEFAULT NULL COMMENT '特权持卡人识别符/证件号',
    remark TEXT DEFAULT NULL COMMENT '卡片备注信息',
    card_type ENUM('guest', 'master', 'floor', 'staff', 'emergency') DEFAULT 'guest',
...
CREATE TABLE card_lifecycle_logs (
    ...
    card_uid VARCHAR(50) NOT NULL,
    hotel_id INT NOT NULL,
    action_type ENUM('issue', 'recycle', 'lost', 'reset', 'activate', 'deactivate', 'status_change', 'update_expiry') NOT NULL,
