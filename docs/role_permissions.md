...
| 功能 | system_admin | hotel_admin | staff | customer | guest |
|------|:-----------:|:----------:|:-----:|:--------:|:-----:|
| 查看优惠券列表 | R(全部) | R(本店) | R(本店) | R(公开) | R(公开) |
| 查看自己的优惠券 | R | R | R | R | R |
| 查看优惠券详情 | R(全部) | R(本店) | R(本店) | R(公开) | R(公开) |
| 创建/编辑/删除优惠券 | CUD | CUD | - | - | - |
| 核销优惠券 | O | O | O | - | - |
| 发放优惠券给用户 | O | O | - | - | - |
| 领取优惠券 | - | - | - | O | O |
...
| 功能 | system_admin | hotel_admin | staff | customer | guest |
|------|:-----------:|:----------:|:-----:|:--------:|:-----:|
| 查看评价列表 | R(全部) | R(本店) | R(本店) | R(公开) | R(公开) |
...
6. **评价归属限制**: customer/guest只能评价自己的订单评价，只能删除自己的评价
...
11. **评价申诉限制**: 仅hotel_admin和staff可发起评价申诉
