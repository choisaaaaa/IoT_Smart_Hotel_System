...
- Name: auth.spec.ts >> 认证模块 >> 权限控制 >> 前台员工不应该访问管理员页面
- Location: specs\auth.spec.ts:117:9
...
Locator: locator('text=无权限|403|Forbidden|前台工作台')
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for locator('text=无权限|403|Forbidden|前台工作台')
