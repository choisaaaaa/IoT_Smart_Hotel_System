...
const columns = [
  ...
  { title: '入住', dataIndex: 'check_in_date', key: 'check_in_date', width: 130, customRender: ({ text }: { text: string }) => formatDateTime(text) },
  { title: '退房', dataIndex: 'check_out_date', key: 'check_out_date', width: 130, customRender: ({ text }: { text: string }) => formatDateTime(text) },
